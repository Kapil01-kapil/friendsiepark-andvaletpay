...
public class SavedPrefManager {
    ...
    /*save String LoginData*/
    public static void saveString(String key,String value) {
       // Hawk.delete(key);
        Hawk.put(key, value);
    }
    /*get String LoginData*/
    public static String getString(String key) {
        return Hawk.get(key);
    }
    /*delete String LoginData*/
   ...
   */
    ...
    public static String getCountryName(Context conteActivity) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(conteActivity);
        String type = sharedPreferences.getString("songs", "");
        return type;
    }
